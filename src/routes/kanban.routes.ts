...
router.patch("/:boardId/lists/:listId/position", authenticateUser, updateListPosition);
...
router.put("/:id/cards/:cardId/comments/:commentId", authenticateUser, updateComment);
router.delete("/:id/cards/:cardId/comments/:commentId", authenticateUser, deleteComment);
...
// COMMENT
router.get("/:id/cards/:cardId/comments", authenticateUser, getCommentsByCardId);

// ACTIVITY
router.post("/:id/cards/:cardId/activities", authenticateUser, createActivity);
router.get("/:id/cards/:cardId/activities", authenticateUser, getActivitiesByCardId);
router.put("/:id/cards/:cardId/activities/:activityId", authenticateUser, updateActivity);
router.delete("/:id/cards/:cardId/activities/:activityId", authenticateUser, deleteActivity);

// CHECKLISTS
router.post("/cards/:cardId/checklists", authenticateUser, createChecklist);
router.get("/cards/:cardId/checklists", authenticateUser, getChecklistsByCardId);
router.put("/checklists/:id", authenticateUser, updateChecklist);
router.delete("/checklists/:id", authenticateUser, deleteChecklist);

// CHECKLIST ITEMS
router.post("/checklists/:checklistId/items", authenticateUser, createChecklistItem);
